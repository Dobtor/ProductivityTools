...
class DobtorTodoListCore(models.Model):
    ...
    timesheet_ids = fields.One2many('account.analytic.line', 'todo_list_id', 'Timesheets')
    ...
    def create_timesheet(self):
        ...
        res = {
            ...
            'view_id': self.env.ref('dobtor_todo_list_timesheet.dobtor_todo_list_project_task_timesheet_wizard').id,
...
class AccountAnalyticLineExtend(models.Model):
    ...
    todo_list_id = fields.Many2one('dobtor.todo.list.core', 'Todo')
