...
class project_project(models.Model):
    ...
    # TODO [IMP][REF]
    @api.multi
    def reference_todo_list(self, new_project):
        for task in new_project.tasks:
            for todo_list in task.todo_list_ids:
    ...
    def copy(self, default=None):
        ...
        self.reference_todo_list(project)
        return project
    ...
    @api.multi
    def _get_todo_list_ids(slef, obj):
        todo_list_ids = []
        for task in obj.task_ids:
            for todo_list in task.todo_list_ids.ids:
                todo_list_ids.append(todo_list)
    ...
    def _get_attachment_domain(self):
        for obj in self:
            ...
            todo_list_domain = [
                ...
                ('res_id', 'in', self._get_todo_list_ids(obj))
            ]
            return ['|'] + domain + todo_list_domain
