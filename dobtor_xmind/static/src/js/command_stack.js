 ...
 */
odoo.define('dobtor_xmind.CommandStack', function (require) {
    "use strict";
     ...
     */
    class UpdateNodeStyleCommand extends Command {
     ...
     */
    class ToggleExpandCommand extends Command {
    ...
    return {
        ...
        UpdateNodeStyleCommand: UpdateNodeStyleCommand,
