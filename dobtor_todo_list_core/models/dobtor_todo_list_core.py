...
class DobtorTodoListCore(models.Model):
    ...
    out_of_deadline = fields.Boolean(
        string="Out of deadline", default=False, compute="_compute_todo_deadline")
    ...
    def attachment_form_view(self):
        ...
        return {
            ...
            'view_id': self.env.ref('dobtor_todo_list_core.view_todo_list_core_attachment_form').id,
            'view_mode': 'form',
            'view_type': 'form',
    ...
    # region Send mail
    @api.multi
    def send_todo_list_email(self, todo_name, todo_state, todo_reviewer_id, todo_user_id, ref_model=None, old_name=None):
